...
public class ImageBinarization {
    ...
    private static final double MAX_BINARY_VALUE = 255.0; // Максимальное значение яркости пикселя
    private static final double MIN_BINARY_VALUE = 0.0; // Максимальное значение яркости пикселя
